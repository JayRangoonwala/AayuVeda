...
const HospitalMap = () => {
    ...
    try {
      ...
      const nearbyHospitals = overpassResponse.data.elements
        ...
        .map((element) => ({
          ...
          distance: calculateDistance(parsedLat, parsedLon, element.lat, element.lon),
        }));
  ...
  return (
    ...
    <header className="top-0 bg-white border-b-2 border-red-600 z-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center space-y-8">
          <SearchBar onSearch={searchHospitals} isLoading={isLoading} />
          ...
          {userLocation && (
            <div className="w-full max-w-2xl">
              <HospitalMapComponent userLocation={userLocation} hospitals={hospitals} />
            </div>
          )}
