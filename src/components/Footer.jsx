          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" aria-label="Twitter" className="w-10 h-10 flex items-center justify-center bg-gray-900 hover:bg-blue-600 rounded-full text-gray-600 hover:text-black transition-colors">
                  🐦
                </a>
                <a href="#" aria-label="GitHub" className="w-10 h-10 flex items-center justify-center bg-gray-900 hover:bg-blue-600 rounded-full text-gray-600 hover:text-black transition-colors">
                  🐙
                </a>
                <a href="#" aria-label="Instagram" className="w-10 h-10 flex items-center justify-center bg-gray-900 hover:bg-blue-600 rounded-full text-gray-600 hover:text-black transition-colors">
                  📷
                </a>
              </div>
            </div>
