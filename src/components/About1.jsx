      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:flex lg:gap-16">
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            ...
            <a href="#about" className="inline-block bg-transparent hover:bg-gray-800 text-black border border-gray-700 font-medium py-2 px-4 rounded transition-colors">
              Learn More About Us
            </a>
          </div>
